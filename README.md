...
| **pytest** | 302 tests across the modeling and serving layers (94 of them in `tests/test_serving.py`) |
...
uv run pytest                                        # run the test suite (302 passing)
...
tests/         pytest suite (302 passing)
```